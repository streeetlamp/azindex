...
//      }
    ...
    function get_post_index_info($index, $row, $hasfilter) {
        ...
        if (!empty($head)) {
            ...
            $subhead = $this->get_post_item($row->ID, $row->post_title, $row->post_excerpt, $row->post_author, null, $index->subhead, $index->subheadkey);
            $desc = $this->get_post_item($row->ID, $row->post_title, $row->post_excerpt, $row->post_author, null, $index->desc, $index->desckey);
